({
    ...
    selectItem : function( component, event, helper ) {
        if(!$A.util.isEmpty(event.currentTarget.id)) {
            ...
            component.set('v.accountNumber',selectedRecord.accountNumber);
            //alert(JSON.stringify(component.get("v.selectedRecord")));
            var appEvent = $A.get("e.c:AccountIdPass");
            appEvent.setParams({
                AccountId : component.get("v.value"),
    ...
    removeItem : function( component, event, helper ){
        ...
        //fire the event again to remove AccountNumber from CreateNEA component
