({
    doInit : function(component, event, helper) {
		...
		var getPausedDate = component.get("c.isPausedDate");
        getPausedDate.setParams({ caseId : component.get("v.recordId") });
        getPausedDate.setCallback(this, function(response) {
            var state = response.getState();
            if (state === "SUCCESS") {
                component.set("v.isPausedDate",response.getReturnValue());
            }
        });
        $A.enqueueAction(getPausedDate);
