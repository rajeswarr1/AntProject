({
	doInit: function(component, event, helper) {
        ...
        component.find("WGRecordCreator").getNewRecord(
            "CH_Workgroup_Event__c", // sObject type (objectApiName)
            null,      // recordTypeId
            false,     // skip cache?
            $A.getCallback(function() {
                var rec = component.get("v.newWGEvent");
                var error = component.get("v.newWGError");
                if(error || (rec === null)) {
    ...
    createRecord : function(component, event, helper) {
             ...
             component.find("WGRecordCreator").saveRecord(function(saveResult) {
