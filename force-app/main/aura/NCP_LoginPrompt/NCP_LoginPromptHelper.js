({
    ...
    // $Label.c.NCP_page_awaiting_approval
    // $Label.c.NCP_page_awaiting_approval_explanation
    ...
    // $Label.c.NCP_general_support_faq
    // $Label.c.NCP_general_support_faq_explanation_stem
    // $Label.c.NCP_general_support_faq_explanation_leaf
    // $Label.c.NCP_general_support_faq_link_text
    ...
    types: {
        ...
        awaitingApproval: {
            icon: 'utility:dislike',
            headline: 'NCP_page_awaiting_approval',
            explanation: 'NCP_page_awaiting_approval_explanation'
        },
        needHelp: {
            icon: 'utility:info',
        ...
        generalSupportFAQ: {
            icon: 'utility:info',
            headline: 'NCP_general_support_faq',
            explanationStem: 'NCP_general_support_faq_explanation_stem',
            explanationLeaf: 'NCP_general_support_faq_explanation_leaf',
            explanationLinkText: 'NCP_general_support_faq_link_text',
            link: 'general-support-faq'
        }
    },
