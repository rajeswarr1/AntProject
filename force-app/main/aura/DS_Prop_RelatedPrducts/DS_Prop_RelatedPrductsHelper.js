({
    showProductsHelper:function(component,event,helper)
    {
        var showProd = false;
        var action = component.get("c.showProducts"); 
        action.setParams({
        ...
        action.setCallback(this, function(response) {             
            ...
            if (state === "SUCCESS") {
                if(response.getReturnValue() == true )
                {
                    ...
                    this.getRelatedProductsHelper(component);
                }
    ...
    getRelatedProductsHelper: function(component,event,helper){
        ...
        component.set('v.IsSpinner',true);
        var action = component.get("c.Relatedproducts");
        action.setParams({
            "currentRecordId": component.get("v.recordId"),
        });
        action.setCallback(this, function(response){
