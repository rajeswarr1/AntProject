({
    uploadBOMHelper: function(component, event, helper) {
        ...
        objFileReader.onload = $A.getCallback(function() {
            ...
            self.uploadBOMData(component, helper, file, fileContents);
        });
        objFileReader.readAsDataURL(file);
    },
    
    uploadBOMData: function(component, helper, file, fileContents) {
        var action = component.get("c.uploadBOM");
        action.setParams({
    ...
    addToCart : function(component, helper) {
        ...
        action.setParams({
            configId: cartId,
            productsToAdd: component.get("v.csvData")
        });
