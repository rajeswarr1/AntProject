({
    saveIndirectOppFromAccount: function(component, event, helper)
    {
        ...
        var opp = component.get("v.newOpportunity");
		...
		saveOpportunityAction.setParams({
            "oppty": component.get("v.newOpportunity"),
            "accountId": accId,
    ...
    saveDirectOppFromAccount: function(component, event, helper)
    {
        component.set('v.loading', true);
        var btn = event.getSource();
        btn.set("v.disabled",true);
        ...
        var saveOpportunityAction = component.get("c.saveDirectOpportunityWithAccount");
		saveOpportunityAction.setParams({
            "oppty": component.get("v.newOpportunity"),
            "accountId": accId
        });
    ...
    saveDirectOppFromContact: function(component, event, helper)
    {
        var btn = event.getSource();
			btn.set("v.disabled",true);
        	...
        	var saveOpportunityAction = component.get("c.saveOpportunityWithContact");
            saveOpportunityAction.setParams({
                "oppty": component.get("v.newOpportunity"),
                "contactId": component.get("v.recordId"),
                "campaignId": component.get("v.cmpg") != null?component.get("v.cmpg").Id:null,
    ...
    validateRequiredFields: function(component)
    {
        ...
        {
        	    errorMessages += 'Win Declaration Planned Date, ';
            	flag = true;
        }
    ...
    fillRecordEditFormFields : function(cmp)
    {
        var opp = cmp.get("v.newOpportunity");
        opp.Lead_BG__c = cmp.find("Lead_BG__c").get("v.value");
        opp.Lead_BU__c = cmp.find("Lead_BU__c").get("v.value");
        opp.Enterprise_Main_Solution__c = cmp.find("Enterprise_Main_Solution__c").get("v.value");
        if(!cmp.get("v.directOpp")){
            opp.Partner_Originated__c = cmp.find("Partner_Originated__c").get("v.value");
        }
    },
})