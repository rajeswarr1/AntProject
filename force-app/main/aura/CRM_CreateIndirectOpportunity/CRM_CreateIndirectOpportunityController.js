    ...
    doInit : function(component, event, helper)
    {
		...
		action.setCallback(this, function(response) 
		{
            ...
            if(state === "SUCCESS")
            {
                ...
                var oppyTypeCmp = component.find("end_customer_information");
                oppyTypeCmp.set("v.value",oppEndCustomerInfoValues[0].value);
                ...
                if(wrapper.defaultAccountRole != null && wrapper.defaultAccountRole != '')
                {
