({
    ...
    createHotlineMember : function(component, event, helper) {
        var getWgId = helper.getJsonFromUrl().uid;
    ...
    showSuccessToast : function(component, event, helper) {
        ...
        toastEvent.setParams({
            "title": "Success!",
            "type":"Success",
            "message": "Hotline Member has been created successfully."
        });
        toastEvent.fire();
    },
    showErrorToast : function(component, event, helper) {
        ...
        toastEvent.setParams({
            "title": "Error!",
            "type":"error",
            "message": "Hotline Member has not been created. Please Check the validations"
        });
        toastEvent.fire();
    },
